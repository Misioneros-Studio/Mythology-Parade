...
void Building::CreateUnit()
{
	...
	case MONASTERY:
		...
		App->entityManager->FxUnits(4, App->entityManager->CreateMonk_sound, position.x, position.y);
	...
	case ENCAMPMENT:
		...
		App->entityManager->FxUnits(4, App->entityManager->CreateAssasin_sound, position.x, position.y);
		if (App->scene->isInTutorial == true)
			App->tutorialscene->unit_created = true;
		break;
	}
...
void Building::StartProducing(const std::string &thing_to_produce) {
	...
	else if (thing_to_produce == "Monk") time_producing = 5;
	else if (thing_to_produce == "Assassin") time_producing = 5;
	else if (thing_to_produce == "Cleric") time_producing = 5;
	else if (thing_to_produce == "Chaotic_Beast") time_producing = 7;
	else if (thing_to_produce == "Lawful_Beast") time_producing = 7;
...
void Building::StartResearching(const std::string &thing_producing) {
	...
	else if (thing_producing == "Temple") time_producing = 5;
	else if (thing_producing == "Chaotic Beast") time_producing = 7;
	else if (thing_producing == "Lawful Beast") time_producing = 7;
