...
void j1TutorialScene::ClickToPath()
{
...
void j1TutorialScene::RestartGame() {
...
void j1TutorialScene::OnClick(UI* element, float argument)
{
...
void j1TutorialScene::FinishResearching(std::string thing_researched) {
